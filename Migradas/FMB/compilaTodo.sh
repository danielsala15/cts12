...
echo Compiling Form $i  ...
  ...
  archivo=$(sed 's/.\{4\}$//' <<< "$i")
  if [ -s $archivo".fmx" ]; then
    echo "Archivo "$archivo".fmx creado..."
#    scp $archivo".fmb" admowner@hph4lp-webl02:/app/CTS/fmb
#    scp $archivo".fmx" admowner@hph4lp-webl02:/app/CTS/fmx
    mv $archivo".fmx" ../fmx/$archivo".fmx"
    rm $archivo".err"
  else
